...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                lbox += (1.0 - iou).mean()  # iou.loss，需要注释掉的原IOU函数
    ...
    def build_targets(self, p, targets):
        # Build targets for compute_loss(), input targets(image,class1,x,y,w,h)
    ...
    def __call__(self, p, targets, imgs):  # predictions, targets, model   
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = bbox_iou(pbox.T, selected_tbox, x1y1x2y2=False, CIoU=True)  # 原ciou iou(prediction, target)
                # iou = bbox_iou(pbox.T, selected_tbox, x1y1x2y2=False, WIoU=True, scale=True)  # Wiou修改 iou(prediction, target)
                lbox += (1.0 - iou).mean()  # iou.loss，需要注释的原函数
