...
class Albumentations:
    # YOLOv5 Albumentations class1 (optional, only used if package is installed)
    def __init__(self):
        self.transform = None
...
def extract_boxes(path='../coco/'):  # from utils.datasets import *; extract_boxes('../coco128')
    # Convert detection dataset into classification dataset, with one directory per class1
